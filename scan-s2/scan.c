...
{
#ifdef __ANDROID__
// show_existing_tuning_data_files is a nop in android
#else
#ifndef DATADIR
...
int main (int argc, char **argv)
{
	...
	/* Start Polling MAX_RUNNING=128 */
	for (i = 0; i < MAX_RUNNING; i++)
		poll_fds[i].fd = -1;

	/* This is where the dvb magic happens */
		/* Open the Front End in Non Blocking Mode */
